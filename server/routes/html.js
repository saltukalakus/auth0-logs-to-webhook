...
module.exports = () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//auth0-logs-to-webhook.now.sh/auth0-logs-to-webhook.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//auth0-logs-to-webhook.now.sh/auth0-logs-to-webhook.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//auth0-logs-to-webhook.now.sh/auth0-logs-to-webhook.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
